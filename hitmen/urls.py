...
from modules.hitman.views import get_tokens_for_user
...
urlpatterns = [
    ...
    path('api/v1/login/', get_tokens_for_user, name='token_obtain_pair'),
    path('api/v1/hits/', include('modules.hits.urls')),
    path('api/v1/hitmen/', include('modules.hitman.urls')),
